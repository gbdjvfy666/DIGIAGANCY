...
const LineBackgroundComponent = ({ width = '100%', height = '200vh', scrollToComponent }) => {
    ...
    useEffect(() => { 
        if (detailsOpen) {
            ...
            // Задержка, чтобы анимация закрытия успела завершиться
            ...
            >
                <div className="max-w-3xl text-center lg:text-left">
                    ...
                    <PrismaticButton
                        ...
                        colors={['#f3f4f6', '#d1d5db', '#6b7280']} // Свежие цвета: светло-серые оттенки
                        hoverColors={['#e5e7eb', '#d1d5db', '#9ca3af']} // Чуть темнее при наведении
                    >
                        Наши Услуги
