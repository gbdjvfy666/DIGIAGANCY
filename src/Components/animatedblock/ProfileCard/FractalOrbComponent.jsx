...
const FractalOrbComponent = ({ width = '100%', height = '100vh' }) => {
    ...
    const animationIdRef = useRef(null); // Ref for animation ID
                ...
                <div className="agency-description">
                    ...
                    <div style={{ marginTop: '2rem' }}>
                        <Link to="/Brief">
                            <PrismaticButton
                                onClick={() => {}} 
                                className="w-full flex items-center justify-center px-10 py-2"
                                colors={['#6b7280', '#4b5563', '#374151']}
                                hoverColors={['#9ca3af', '#6b7280', '#4b5563']}
                            >
                                Заполнить бриф
                            </PrismaticButton>
                        </Link>
