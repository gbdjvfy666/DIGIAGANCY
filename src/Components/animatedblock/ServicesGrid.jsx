...
  const videoData = [
    { title: 'Intro', src: video1 }, // Новый блок с видео, используем video1
...
        {/* Блок с текстом (2/3) */}
        <div className="w-2/3 bg-black border border-gray-200 dark:border-white h-[400px] relative overflow-hidden flex items-end p-4">
          <p className="text-3xl font-bold text-white"> {/* Изменен text-gray-800 на text-white */}
            This is the descriptive text that explains what we do.
          </p>
        </div>
        {/* Блок с видео (1/3) */}
        <div
