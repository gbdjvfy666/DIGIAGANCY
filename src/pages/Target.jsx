...
const strategyIcons = [
    ...
    (props) => <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinecap="round" strokeWidth="1.5" d="M4 4v5h5M5 19v-5h5m10-4v5h-5M19 5v5h-5" /></svg>,
...
export default function PremiumVkTarget() {
    ...
    const defaultColors = ["#a855f7", "#ec4899"]; // Фиолетово-розовый
    const hoverColors = ["#d8b4fe", "#fda4af"]; // Более светлые и мягкие оттенки

    // Состояния для второй кнопки
    const [isHovered2, setIsHovered2] = useState(false);
    const defaultColors2 = ["#4f8cff", "#00c6ff"]; // Исходный сине-голубой
    const hoverColors2 = ["#bfdbfe", "#93c5fd"]; // Очень светлые сине-голубые
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
            ...
            >
                ...
                {/* --- FAQ Section could be added here if needed --- */}
